...
for g = 1:file_repeat_count
    ...
    for n = 1:file_content_count
        ...
        % fileID = fopen('result_¦¶¤h»Í.txt','a');
        % test_file_name = strcat(num2str(n-1), '_¦¶¤h»Í_', num2str(g), '.wav');
        % fileID = fopen('result_¤ýµ¤·×.txt','a');
        % test_file_name = strcat(num2str(g-1), '_¤ýµ¤·×_',num2str(n-1), '.wav');
        % fileID = fopen('result_¶À­õ«C.txt','a');
        % test_file_name = strcat(num2str(g-1), '_¶À­õ«C_', num2str(n-1), '.wav');
        % fileID = fopen('result_³¯¼Ý°a.txt','a');
        % test_file_name = strcat(num2str(n-1), '_³¯¼Ý°a_', num2str(g), '.wav');
        % fileID = fopen('result_¾Gµq¿A.txt','a');
        % test_file_name = strcat(num2str(n-1), '_¾Gµq¿A_', num2str(g), '.wav');
        fileID = fopen('result_±i§Õªä.txt','a');
        test_file_name = strcat(num2str(n-1), '_±i§Õªä_', num2str(g), '.wav');
        fprintf(fileID,'%s\n', test_file_name);
        fclose(fileID);
        ...
        % reference_file_name = strcat('../¦¶¤h»Í/', num2str(n-1), '_', num2str(g), '.wav');
        % reference_file_name = strcat('../¤ýµ¤·×/w', num2str(g-1), '_', num2str(n-1), '.wav');
        % reference_file_name = strcat('../¶À­õ«C/w', num2str(g-1), '_', num2str(n-1), '.wav');
        % reference_file_name = strcat('../³¯¼Ý°a/', num2str(n-1), '_', num2str(g), '.wav');
        % reference_file_name = strcat('../¾Gµq¿A/', num2str(n-1), '_', num2str(g), '.wav');
        reference_file_name = strcat('../±i§Õªä/ch0', num2str(n-1), '0', num2str(g), '.wav');
        ...
        for m = 1:file_repeat_count
            ...
            for f = 1:file_content_count
                ...
                % target_file_name = strcat('../¦¶¤h»Í/', num2str(f-1), '_', num2str(m), '.wav');
                % target_file_name = strcat('../¤ýµ¤·×/w', num2str(m-1), '_', num2str(f-1), '.wav');
                % target_file_name = strcat('../¶À­õ«C/w', num2str(m-1), '_', num2str(f-1), '.wav');
                % target_file_name = strcat('../³¯¼Ý°a/', num2str(f-1), '_', num2str(m), '.wav');
                % target_file_name = strcat('../¾Gµq¿A/', num2str(f-1), '_', num2str(m), '.wav');
                target_file_name = strcat('../±i§Õªä/ch0', num2str(f-1), '0', num2str(m), '.wav');
